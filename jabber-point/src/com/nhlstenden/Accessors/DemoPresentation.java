...
class DemoPresentation extends Accessor {
    ...
    public void loadFile(Presentation presentation, String unusedFilename) {
        ...
        slide.append(
                "text",
                1,
                "The Java com.nhlstenden.Presentation Tool"
        );
        slide.append(
                "text",
                2,
        ...
        slide.append(
                "text",
                2, "Copyright (c) 2000-now:"
        );
        slide.append(
                "text",
                2, "Gert Florijn and Sylvia Stuurman"
        );
        slide.append(
                "text",
                4,
                "Starting com.nhlstenden.JabberPoint without a filename"
        );
        slide.append(
                "text",
                4,
        ...
        slide.append(
                "image",
                1,
                "jabber-point/JabberPoint.gif"); // Using image factory
        presentation.append(slide);
    }
